...
if walkingWeather == true {
//insert print statements here!!
    print("I'm going for a walk")
} else {
    print("I'm not going for a walk")
}
print("For the first set, I will go for a walk")
print("For the second set, I will not go for a walk")
print("For the third set, I will go for a walk")
